        ...
        <section className="testimonials">
            ...
            <section className="testimonials-container">
                <div className="testimonials-item">
                    <img src={emily} alt="emily" className="testimonial-emily" />
                ...
                <div className="testimonials-item">
                    <img src={thomas} alt="thomas" className='testimonial-thomas' />
                    <p className="testimonial-desc">
                ...
                <div className="testimonials-item">
                    <img src={jennie} alt="jennie" className='testimonial-jennie' />
                    <p className="testimonial-desc">
